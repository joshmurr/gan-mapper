...
class PerceptualLoss(torch.nn.Module):
    ...
    def forward(self, pred, target, normalize=False):
        ...
        If normalize is True, assumes the images are between [0,1] and then
        scales them between [-1,+1]. If normalize is False, assumes the images
        are already between [-1,+1].
